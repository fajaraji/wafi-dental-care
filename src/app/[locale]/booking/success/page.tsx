        ...
        <div className="mx-auto max-w-lg px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href={`/${locale}`}
                className="rounded-xl bg-gradient-to-r from-brand-600 to-accent-500 px-8 py-3 text-sm font-bold text-white shadow-lg shadow-brand-600/25 transition-all duration-300 hover:scale-105 hover:shadow-xl"
              >
                {t("backToHome")}
              </Link>
              <a
