        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group rounded-2xl bg-paper p-8 text-center transition-all duration-300 hover:bg-surface-white"
            >
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full border border-brand-600/25 text-brand-700 transition-colors duration-300 group-hover:border-gold-500/60">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
              ...
              <h3 className="mt-4 font-display text-lg font-medium text-brand-800">Instagram</h3>
              <p className="mt-2 text-text-muted">@wafidentalcare</p>
